...
커스텀 데이터셋을 구축하고 Hugging Face transformers 라이브러리의 BERT 모델을 파인튜닝하여, 실제 서비스 환셩에 준하는 F1-Score 92%의 고성능 모델을 구현하였습니다.
 ...
 * **최종 최적화** : 학습률을 1e-5에서 2e-5으로 높이고 가중치를 미세 조정하여 오탐을 줄였고, 최종적으로 F1-Score 91%를 달성하였습니다.
